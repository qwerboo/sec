...
keyword_forex = ['currency', 'foreign exchange', 'exchange rate']
...
def main(env):
    ...
    for inter in keyword_interest:
        reg = reg_model%(inter, keyword_b, keyword_c)
        reg_interest.append(reg)
    for inter in keyword_interest:
        reg = reg_model%(inter, keyword_c, keyword_b)
        reg_interest.append(reg)
    for inter in keyword_b:
        reg = reg_model%(inter, keyword_interest, keyword_c)
        reg_interest.append(reg)
    for inter in keyword_b:
        reg = reg_model%(inter, keyword_c, keyword_interest)
        reg_interest.append(reg)
    for inter in keyword_c:
        reg = reg_model%(inter, keyword_interest, keyword_b)
        reg_interest.append(reg)
    for inter in keyword_c:
        reg = reg_model%(inter, keyword_b, keyword_interest)
        reg_interest.append(reg)
    ...
    for inter in keyword_forex:
        ...
        reg_forex.append(reg)
    for inter in keyword_b:
        reg = reg_model%(inter, keyword_forex, keyword_c)
        reg_forex.append(reg)
    for inter in keyword_b:
        reg = reg_model%(inter, keyword_c, keyword_forex)
        reg_forex.append(reg)
    for inter in keyword_c:
        reg = reg_model%(inter, keyword_forex, keyword_b)
        reg_forex.append(reg)
    for inter in keyword_c:
        reg = reg_model%(inter, keyword_b, keyword_forex)
        reg_forex.append(reg)
    while True:
